...
-- para adicionar os campos necessários à tabela email_templates
...
-- 2. Adicionar campos necessários à tabela email_templates
...
-- 3. Atualizar templates existentes para serem vinculados ao formulário
...
-- 5. Criar trigger para atualizar updated_at (apenas se não existir)
DO $$
BEGIN
  IF NOT EXISTS (
